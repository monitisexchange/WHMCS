...
}).html('<div class="contexthelp"><a href="../modules/addons/monitis_addon/help/?act=<?=$pageName?>" target="_blank"><img src="images/icons/help.png" border="0" align="<?=$pageName?> help"> Help</a></div>');
